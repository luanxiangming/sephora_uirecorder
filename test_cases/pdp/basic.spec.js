...
module.exports = function(){
    ...
    it('click: li:nth-child(2) > img, 35, 37, 0', async function(){
        await driver.sleep(300).wait('li:nth-child(2) > img', 30000)
               .sleep(300).mouseMove(35, 37).click(0);
    });
    ...
    it('click: li:nth-child(3) > img, 26, 26, 0', async function(){
        await driver.sleep(300).wait('li:nth-child(3) > img', 30000)
               .sleep(300).mouseMove(26, 26).click(0);
    });
    ...
    it('expect: displayed, div.testBox > p:nth-child(3), equal, true', async function(){
        await driver.sleep(300).wait('div.testBox > p:nth-child(3)', 30000)
            .displayed()
            .should.not.be.a('error')
            .should.equal(_(true));
    });

    it('expect: displayed, div.testBox > p:nth-child(2), equal, true', async function(){
        await driver.sleep(300).wait('div.testBox > p:nth-child(2)', 30000)
            .displayed()
            .should.not.be.a('error')
            .should.equal(_(true));
    });

    it('expect: displayed, div.ProductMainMixture > div.price, equal, true', async function(){
        await driver.sleep(300).wait('div.ProductMainMixture > div.price', 30000)
            .displayed()
            .should.not.be.a('error')
            .should.equal(_(true));
    });
