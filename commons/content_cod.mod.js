...
module.exports = function(){
    ...
    it('click: 货到付款 ( li:nth-child(2) > a:nth-child(2) > span, 31, 5, 0 )', async function(){
        await driver.sleep(300).wait('li:nth-child(2) > a:nth-child(2) > span', 30000)
               .sleep(300).mouseMove(31, 5).click(0);
    });
