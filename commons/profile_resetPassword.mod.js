...
module.exports = function(){
    ...
    it('click: 更改密码 ( ul:nth-child(4) > li:nth-child(3), 76, 17, 0 )', async function(){
        await driver.sleep(300).wait('ul:nth-child(4) > li:nth-child(3)', 30000)
               .sleep(300).mouseMove(76, 17).click(0);
    });
    ...
    it('expect: imgdiff, div.imageStep, below, {{imgdiff}}', async function(){
        let self = this;
    ...
    it('expect: displayed, div.secondBox > div.clearFix, equal, true', async function(){
        await driver.sleep(300).wait('div.secondBox > div.clearFix', 30000)
            .displayed()
