...
module.exports = function(){
    ...
    it('expect: displayed, a.NoInfoRight, equal, true', async function(){
        await driver.sleep(300).wait('a.NoInfoRight', 30000)
            .displayed()
            .should.not.be.a('error')
            .should.equal(_(true));
    });

    it('click: 品牌故事 ( a.NoInfoRight, 54, 20, 0 )', async function(){
        await driver.sleep(300).wait('a.NoInfoRight', 30000)
               .sleep(300).mouseMove(54, 20).click(0);
    });
