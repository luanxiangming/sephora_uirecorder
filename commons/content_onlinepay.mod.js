...
module.exports = function(){
    ...
    it('click: 在线支付 ( li:nth-child(2) > a:nth-child(3) > span, 30, 4, 0 )', async function(){
        await driver.sleep(300).wait('li:nth-child(2) > a:nth-child(3) > span', 30000)
               .sleep(300).mouseMove(30, 4).click(0);
    });
