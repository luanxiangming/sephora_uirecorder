...
module.exports = function(){
    ...
    it('scrollTo: 0, 7244', async function(){
        await driver.scrollTo(0, 7244);
    });

    it('click: 联系我们 ( li:nth-child(4) > a:nth-child(3) > span, 33, 4, 0 )', async function(){
        await driver.sleep(300).wait('li:nth-child(4) > a:nth-child(3) > span', 30000)
               .sleep(300).mouseMove(33, 4).click(0);
    });
    ...
    it('expect: imgdiff, div.aboutDetail, below, 5', async function(){
        let self = this;
