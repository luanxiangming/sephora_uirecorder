...
module.exports = function(){
    ...
    it('sendKeys: {DOWN}', async function(){
        await driver.sendKeys('{RIGHT}{DOWN}');
    });

    it('scrollTo: 0, 6084', async function(){
        await driver.scrollTo(0, 6084);
    });
    ...
    it('click: 退换货规定 ( li:nth-child(3) > a:nth-child(2) > span, 34, 3, 0 )', async function(){
        await driver.sleep(300).wait('li:nth-child(3) > a:nth-child(2) > span', 30000)
