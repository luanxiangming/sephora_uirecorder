...
module.exports = function(){
    ...
    it('scrollTo: 0, 7236', async function(){
        await driver.scrollTo(0, 7236);
    });

    it('click: 大宗采购/团购 ( li:nth-child(1) > a:nth-child(2) > span, 30, 5, 0 )', async function(){
        await driver.sleep(300).wait('li:nth-child(1) > a:nth-child(2) > span', 30000)
    ...
    it('scrollTo: 0, 4', async function(){
        await driver.scrollTo(0, 4);
    });

    it('expect: url, , equal, {{giftcard_url}}', async function(){
        await driver
            .url()
            .should.not.be.a('error')
            .should.equal(_(`https://www.sephora.cn/content/giftcard/`));
    });
