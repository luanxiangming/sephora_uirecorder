...
module.exports = function(){
    ...
    it('click: 退换及退款说明 ( li:nth-child(3) > a:nth-child(3) > span, 55, 11, 0 )', async function(){
        await driver.sleep(300).wait('li:nth-child(3) > a:nth-child(3) > span', 30000)
               .sleep(300).mouseMove(55, 11).click(0);
    });
